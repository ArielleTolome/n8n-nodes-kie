...
This package is already published to npm as `n8n-nodes-kie`. Users can install it on self-hosted n8n instances via the GUI or CLI.
...
- **GUI install:** Settings → Community Nodes → Install → enter `n8n-nodes-kie`
- **CLI install:** `npm install n8n-nodes-kie` in the n8n data directory
...
- [ ] Package name starts with `n8n-nodes-` ✅ (`n8n-nodes-kie`)
