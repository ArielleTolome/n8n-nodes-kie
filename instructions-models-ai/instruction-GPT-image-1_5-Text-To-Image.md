# 1.5 Text To Image API Documentation

> Generate content using the 1.5 Text To Image model

## Overview

This document describes how to use the 1.5 Text To Image model for content generation. The process consists of two steps:
...
|-----------|------|----------|-------------|
| model | string | Yes | Model name, format: `gpt-image/1.5-text-to-image` |
...
|----------|-------|-------------|
| **Format** | `gpt-image/1.5-text-to-image` | The exact model identifier for this API |
...
```json
{
  ...
  "data": {
    ...
    "model": "gpt-image/1.5-text-to-image",
    "state": "waiting",
    "param": "{\"model\":\"gpt-image/1.5-text-to-image\",\"input\":{\"prompt\":\"Create a photorealistic candid photograph of an elderly sailor standing on a small fishing boat.  He has weathered skin with visible wrinkles, pores, and sun texture, and a few faded traditional sailor tattoos on his arms. He is calmly adjusting a net while his dog sits nearby on the deck. Shot like a 35mm film photograph, medium close-up at eye level, using a 50mm lens. The image should feel honest and unposed, with real skin texture, worn materials, and everyday detail. No glamorization, no heavy retouching. \",\"aspect_ratio\":\"3:2\",\"quality\":\"medium\"}}",
    "resultJson": "{\"resultUrls\":[\"https://static.aiquickdraw.com/tools/example/1765961172105_jRGzhUQE.webp\"]}",
    "failCode": null,
    "failMsg": null,
    "costTime": null,
    "completeTime": null,
